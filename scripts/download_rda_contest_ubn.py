#!/usr/bin/env python3
"""
Download UA9QCQ RDA Contest UBN logs for selected dates.

Writes all logs into RDAContest/<year>/.
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-rda-ubn-downloader",
        "CONTEST: RDA",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for RDA Contest."
    )
    parser.add_argument(
        "--year",
