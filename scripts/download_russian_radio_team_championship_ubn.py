#!/usr/bin/env python3
"""
Download UA9QCQ Russian Radio Team Championship UBN logs for selected dates.

Writes all logs into RussianRadioTeamChampionship/<year>/.
...
TEST_ID = "116"  # Russian Radio Team Championship
REQUEST_TIMEOUT = 30
...
PROGRESS_LABEL = "Russian Radio Team Championship"
DEFAULT_MODE = "MIXED"
DEFAULT_BAND = "ALL"
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-russian-radio-team-ubn-downloader",
        "CONTEST: RUSSIAN-RADIO-TEAM",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for Russian Radio Team Championship."
    )
    parser.add_argument(
        "--year",
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("RussianRadioTeamChampionship"),
