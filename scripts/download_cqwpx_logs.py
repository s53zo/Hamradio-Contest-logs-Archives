#!/usr/bin/env python3
"""
Download the full CQ WPX public log archive.
...
The script scrapes https://cqwpx.com/publiclogs/ to discover year/mode pages,
...
def download_log(year: str, mode: str, log_url: str) -> None:
    """Download a single log file into CQWPX/<mode>/<year>/."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download CQ WPX public logs.")
    parser.add_argument(
        "--last",
        type=int,
        default=None,
