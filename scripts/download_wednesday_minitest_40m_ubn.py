#!/usr/bin/env python3
"""
Download UA9QCQ Wednesday Mini-Test 40m UBN logs for selected dates.
...
TEST_ID = "242"  # Wednesday Mini-Test 40m
REQUEST_TIMEOUT = 30
...
PROGRESS_LABEL = "Wednesday Mini-Test 40m"
DEFAULT_MODE = "CW"
DEFAULT_BAND = "40M"
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-wed-mini-test-40m-ubn-downloader",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for Wednesday Mini-Test 40m."
    )
    parser.add_argument(
        "--year",
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("WednesdayMiniTest40m"),
