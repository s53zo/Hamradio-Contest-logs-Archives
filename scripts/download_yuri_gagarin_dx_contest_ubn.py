#!/usr/bin/env python3
"""
Download UA9QCQ Yuri Gagarin International DX Contest UBN logs for selected dates.

Writes all logs into YuriGagarinDXContest/<year>/.
...
TEST_ID = "130"  # Yuri Gagarin International DX Contest
REQUEST_TIMEOUT = 30
...
PROGRESS_LABEL = "Yuri Gagarin International DX Contest"
DEFAULT_MODE = "MIXED"
DEFAULT_BAND = "ALL"
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-yuri-gagarin-dx-ubn-downloader",
        "CONTEST: YURI-GAGARIN-DX",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for Yuri Gagarin International DX Contest."
    )
    parser.add_argument(
        "--year",
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("YuriGagarinDXContest"),
