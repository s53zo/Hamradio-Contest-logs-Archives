#!/usr/bin/env python3
"""
Download UA9QCQ RF Championship CW UBN logs for selected dates.

Writes all logs into RFChampionshipCW/<year>/.
...
TEST_ID = "114"  # RF Championship CW
REQUEST_TIMEOUT = 30
...
PROGRESS_LABEL = "RF Championship CW"
DEFAULT_MODE = "CW"
DEFAULT_BAND = "ALL"
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-rf-championship-cw-ubn-downloader",
        "CONTEST: RF-CHAMPIONSHIP-CW",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for RF Championship CW."
    )
    parser.add_argument(
        "--year",
