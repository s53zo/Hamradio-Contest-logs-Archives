#!/usr/bin/env python3
"""
Download UA9QCQ RCC Cup UBN logs for selected dates.

Writes all logs into RCCCup/<year>/.
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-rcc-cup-ubn-downloader",
        "CONTEST: RCC-CUP",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for RCC Cup."
    )
    parser.add_argument(
        "--year",
