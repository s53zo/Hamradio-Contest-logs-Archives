#!/usr/bin/env python3
"""
Download UA9QCQ Ham Spirit Contest UBN logs for selected dates.

Writes all logs into HamSpiritContest/<year>/.
...
TEST_ID = "268"  # Ham Spirit Contest
REQUEST_TIMEOUT = 30
...
PROGRESS_LABEL = "Ham Spirit Contest"
DEFAULT_MODE = "MIXED"
DEFAULT_BAND = "ALL"
...
def build_cabrillo(
    ...
    lines = [
        "START-OF-LOG: 3.0",
        "CREATED-BY: ua9qcq-ham-spirit-ubn-downloader",
        "CONTEST: HAM-SPIRIT",
        f"CALLSIGN: {call}",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch UA9QCQ UBN logs for Ham Spirit Contest."
    )
    parser.add_argument(
        "--year",
